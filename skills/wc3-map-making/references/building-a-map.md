...
5. Symmetry: build **one** half or quadrant well, then `mirror` it (`axis` x, y, point, rot90/180/270). For a four-quadrant map, mirror x over a quadrant, then mirror y over the whole finished half — mirroring the still-empty half copies emptiness.
