...
- Handle types that work as globals include `unit`, `group`, `rect`, `location`, `item`, `force`, `player`, `trigger`, `timer`, `hashtable`, `fogmodifier`, `effect`, `lightning`, `texttag`, `quest`, `sound`, `destructable`, `image`, `camerasetup`, `gamecache` and `handle`, plus `integer`, `real`, `boolean`, `string`, `dialog`, `leaderboard`, `multiboard`, `timerdialog`. `data_search kind=trigger_type` lists them all.
